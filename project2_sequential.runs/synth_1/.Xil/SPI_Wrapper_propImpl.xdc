set_property SRC_FILE_INFO {cfile:C:/Project2_SPI/Wrapper_Basys3.xdc rfile:../../../Wrapper_Basys3.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {MISO}]
