...
// Date        : Wed Aug 23 02:20:36 2023
// Host        : Dell-G5 running 64-bit major release  (build 9200)
// Command     : write_verilog -force SPI_Wrapper_netlist_sequential.v
// Design      : SPI_Wrapper
  ...
  LUT5 #(
    ...
    \FSM_sequential_cs[2]_i_2 
       (.I0(cs[2]),
        ...
        .I4(cs[1]),
        .O(ns));
  (* FSM_ENCODED_STATES = "CHK_CMD:001,READ_ADD:011,WRITE:100,READ_DATA:010,IDLE:000" *) 
  (* KEEP = "yes" *) 
  FDRE #(
    .INIT(1'b0)) 
